...
public class TaskService {
    ...
    public TaskDtoResponse createTasks(TaskRequestDto taskRequestDto) {
       Tasks tasks = new Tasks();
       tasks.setTitle(taskRequestDto.getTitle());
       tasks.setDescription(taskRequestDto.getDescription());
       tasks.setStatus(taskRequestDto.getStatus());
       tasks.setType(taskRequestDto.getType());
       tasks.setStartDate(taskRequestDto.getStartDate().withZoneSameInstant(ZoneId.of("UTC")));
       tasks.setEndDate(taskRequestDto.getEndDate().withZoneSameInstant(ZoneId.of("UTC")));
    ...
    public  TaskDtoResponse updateTasks(int id, TaskRequestDto taskRequestDto) {
