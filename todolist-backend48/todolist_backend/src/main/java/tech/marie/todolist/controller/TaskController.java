...
public class TaskController {
    ...
    public ResponseEntity<TaskDtoResponse> createTasks(@RequestBody TaskRequestDto taskRequestDto) {
        return new ResponseEntity<>(taskService.createTasks(taskRequestDto), HttpStatus.CREATED);
...
// get all tasks
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<TaskDtoResponse> updateTask(@PathVariable int id, @RequestBody TaskRequestDto taskRequestDto) {
        return ResponseEntity.ok(taskService.updateTasks(id, taskRequestDto));
    }
